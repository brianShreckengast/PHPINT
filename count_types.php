...
function count_types($string){

	//This function takes a string as input and returns an array counting the number of times each datatype is used in the string
	...
	//Loop through array and check data type of each value
	foreach ($wordArray as $word){

		//Check if it converts to a number
		if(intval($word)){
